# VelocityShearPropagation.py
#
# Utility classes and functions for velocity shear propagation algorithm/ 
#   2020-06-12  zduguid@mit.edu    implemented VelocityShearPropagation.py
